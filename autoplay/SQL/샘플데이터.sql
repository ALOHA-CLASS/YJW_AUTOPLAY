...
(UUID(), '에테르', '하늘을 지배하는 ''스카이본(Skyborne)''에게 2등 시민으로 낙인찍힌 윌 라란. 그는 주어진 운명에 굴복하지 않고, 스스로의 길을 찾기 위해 목숨을 건 여정을 시작한다.', '고시각', 'https://youtu.be/B-NPJqzNzug', 'B-NPJqzNzug', 'Jo-TZQdNvNk', '/img/thumb/high/에테르.jpg', 3),
