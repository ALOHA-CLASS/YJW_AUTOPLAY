...
(UUID(), '비온 뒤 차차', '철거 전문 일을 하며 성실하게 살아가는 신우와 디자인 회사의 촉망받는 인재였던 수정, 어느 날 전 직장 선배를 통해 소개팅 기회가 찾아오고 설레는 마음으로 소개팅에 나가게 되는데...', '저시각', 'https://youtu.be/Zwidok1WsbI', 'Zwidok1WsbI', '/img/thumb/low/비온뒤차차.jpeg', 7),
(UUID(), '히키코모루', '그녀의 일상은 규칙적이고 통제된 상태로 진행된다. 그녀는 무언가로 부터 도망치고 방안에 틀어 박혔다. 완벽하고 싶었던 그녀가 도망친 것은 소중했던 관계 그리고 절실 했었던 꿈이다. 하지만 집안으로 스며 들어오는 사소한 자극은 그녀가 도망친 것들을 다시 생각나게 한다.', '저시각', 'https://youtu.be/RTROgAP5jP0', 'RTROgAP5jP0', '/img/thumb/low/히키코모루.jpg', 8),
(UUID(), '거리의 연기자', '거장 감독의 작품 오디션 연락을 받은 태희. 오랜만의 오디션이라 설레는 기대감으로 오디션에 나서지만 모든 것이 예상 밖이다.기대했던 감독과의 만남도 없고, 사무실이나 연습실이 아닌 길거리에서 연기를 해보라고 하는 조감독. 이 모든 상황이 당황스러운 태희.', '저시각', 'https://youtu.be/gW1bCuahX-M', 'gW1bCuahX-M', '/img/thumb/low/거리의연기자.png', 9);